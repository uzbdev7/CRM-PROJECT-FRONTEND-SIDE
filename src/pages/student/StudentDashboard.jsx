        ...
        <nav style={{ display:"flex",gap:2,marginLeft:24 }}>
          {NAV.map(n => (
            <button key={n.id} onClick={() => setTab(n.id)} style={{
              ...
              background: tab===n.id ? "rgba(251,191,36,.08)" : "none",
              color: tab===n.id ? "#FCD34D" : "#4A5568",
              border: tab===n.id ? "1px solid rgba(251,191,36,.2)" : "1px solid transparent",
          ...
          <div className="fade-up">
            ...
            <div className="card" style={{ padding:"32px 36px",marginBottom:20,position:"relative",overflow:"hidden" }}>
              <div style={{
                ...
                background:"radial-gradient(circle at 80% 30%,rgba(251,191,36,.08) 0%,transparent 70%)",
                pointerEvents:"none",
              }}/>
              ...
              <p style={{ color:"#4A5568",fontSize:14,marginBottom:20 }}>
                Bugungi darslaringiz va topshiriqlaringizni kuzating
              </p>
              <div style={{ display:"inline-flex",alignItems:"center",gap:8 }}>
                <Badge role={user.role}/>
                <span style={{ color:"#2D3A5C",fontSize:12 }}>·</span>
                <span style={{ display:"flex",alignItems:"center",gap:5 }}>
                  <span style={{ width:6,height:6,borderRadius:"50%",background:"#FCD34D",animation:"pulse 1.8s ease-in-out infinite" }}/>
                  <span style={{ color:"#FCD34D",fontSize:12 }}>Faol</span>
                </span>
              </div>
            </div>
            ...
            <div style={{ display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:14,marginBottom:20 }}>
              {[
                { i:"📖", l:"Fanlar",       v:"—", c:"#F59E0B" },
                { i:"✅", l:"Davomat",      v:"—", c:"#63DAB1" },
                { i:"📝", l:"Topshiriqlar", v:"—", c:"#4299E1" },
                { i:"⭐", l:"Ball",         v:"—", c:"#A78BFA" },
              ].map((s, i) => (
            ...
            <div className="card" style={{ padding:24,textAlign:"center" }}>
              ...
              <div style={{ color:"#4A5568",fontSize:13,lineHeight:1.6 }}>
                Darslar, topshiriqlar va davomat ma'lumotlari backend to'liq ulangach ko'rinadi.<br/>
                <code style={{ color:"#2D3A5C",fontSize:11 }}>POST /student/login → STUDENT token</code>
              </div>
            </div>
          </div>
        )}
        ...
        {tab === "profile" && (
          <div className="fade-up" style={{ maxWidth:460,margin:"0 auto" }}>
            <div className="card" style={{ padding:28,textAlign:"center",marginBottom:14 }}>
              ...
              <p style={{ color:"#4A5568",fontSize:13,marginBottom:10 }}>{user.position || "O'quvchi"}</p>
              <Badge role={user.role}/>
            </div>

            <div className="card" style={{ padding:20,marginBottom:12 }}>
              <div style={{ display:"flex",alignItems:"center",gap:7,marginBottom:14 }}>
                <div style={{ width:3,height:13,background:"#FCD34D",borderRadius:2 }}/>
